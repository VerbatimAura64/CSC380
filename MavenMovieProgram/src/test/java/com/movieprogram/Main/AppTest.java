    ...
    extends TestCase
{
    ...
    public void testApp() throws AWTException, IOException, SQLException
    {
        ...
        bot.delay(1000);
        bot.mouseMove(monthx+6, monthy+6);
        bot.delay(500);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(500);
        ...
        bot.delay(1000);
        bot.mouseMove(nameCardx+5, nameCardy+5);
        bot.delay(500);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.keyPress(16);
        bot.delay(100);
        ...
        bot.delay(1000);
        bot.mouseMove(confirmx+7, confirmy+7);
        bot.delay(500);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        ...
        //Confirmation Page
        bot.delay(5000);
        bot.mouseMove(quitx+10, quity+8);
        bot.delay(500);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(1000);
        ...
        //Login Again
        //UserID
        bot.mouseMove(userx+10, usery+6);
        bot.delay(100);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(1000);
        ...
        //Password
        bot.delay(500);
        bot.mouseMove(passTextx+7, passTexty+7);
        bot.delay(100);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(100);
        bot.keyPress(80); //p
        ...
        bot.delay(500);
        bot.mouseMove(signinx+10, signiny+10);
        bot.delay(100);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(1000);

        bot.mouseMove(pricex+20, pricey+10);
        bot.delay(100);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(200);
        ...
        bot.keyPress(53);
        bot.delay(2000);
        bot.mouseMove(applyx+10, applyy+6);
        bot.delay(100);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(2000);
        bot.mouseMove(closex+5, closey+7);
        bot.delay(100);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(2000);
        
        //Back to Login and into Sign Up
        bot.mouseMove(SUBx+6, SUBy+5);
        bot.delay(100);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK);bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(100);
        ...
        //Sign Up
        bot.delay(1000);
        bot.mouseMove(namex+10, namey+7);
        bot.keyPress(16);
        bot.delay(100);
        bot.keyPress(65); //A
        bot.delay(100);
        ...
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK);bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(1000);
        bot.mouseMove(emailx+6, emaily+7);
        bot.delay(100);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK);bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(100);
        bot.keyPress(65); //a
        ...
        bot.keyPress(85); //u
        bot.delay(500);
        bot.mouseMove(verifyex+7, verifyey+8);
        bot.delay(200);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK);bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(100);
        bot.keyPress(65); //a
        ...
        bot.keyPress(83); //s
        bot.delay(1000);
        bot.mouseMove(verifypx+6, verifypy+10);
        bot.delay(200);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK);bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(100);
        bot.keyPress(16);
        ...
        bot.keyPress(83); //s
        bot.delay(1000);
        bot.mouseMove(tnsx+4, tnsy+3);
        bot.delay(200);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK);bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(300);
        bot.mouseMove(acceptx+5, accepty+5);
        bot.delay(200);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK);bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        ...
        //Main Window
        bot.delay(2000);
        bot.mouseMove(gotgpx+6, gotgpy +15);
        bot.delay(500);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(5000);
        bot.mouseMove(backx+4, backy+7);
        bot.delay(500);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(2000);
        ...
        bot.delay(1000);
        bot.mouseMove(monthx+7, monthy+9);
        bot.delay(500);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(500);
        ...
        bot.delay(1000);
        bot.mouseMove(nameCardx+6, nameCardy+4);
        bot.delay(500);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.keyPress(16);
        bot.delay(100);
        ...
        bot.delay(1000);
        bot.mouseMove(addressx+3, addressy+7);
        bot.delay(500);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.keyPress(16);
        bot.delay(100);
        ...
        bot.delay(1000);
        bot.mouseMove(statex+4, statey+6);
        bot.delay(500);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(500);
        bot.mouseMove(statex+35, statey+50);
        ...
        bot.delay(1000);
        bot.mouseMove(confirmx+5, confirmy+5);
        bot.delay(500);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        ...
        //Confirmation Page
        bot.delay(5000);
        bot.mouseMove(quitx+10, quity+6);
        bot.delay(500);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(5000);
    }   
