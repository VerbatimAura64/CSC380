    ...
    extends TestCase
{
    ...
    public void testApp() throws AWTException, IOException
    {
        ...
        bot.delay(500);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.mouseMove(gotgx, gotgy);
        bot.delay(500);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(2000);
        bot.mouseMove(timex, timey);
        bot.delay(500);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        ...
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(500);
        bot.mouseMove(yearx+9, yeary+97);
        bot.delay(500);
        bot.mousePress(InputEvent.BUTTON1_DOWN_MASK); bot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
        bot.delay(500);
